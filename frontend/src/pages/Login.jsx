...
import ByteLogLogo from "../component/ByteLog-Logo.jsx";
    ...
    return(
        <div className="flex flex-col justify-center items-center">
            <div className="text-center flex flex-col gap-2 my-10">
                ...
                <p className="text-sm sm:text-base">or <a onClick={()=>navigate("/register")} className="text-cyan-500 cursor-pointer">Create an account</a></p>
            </div>
