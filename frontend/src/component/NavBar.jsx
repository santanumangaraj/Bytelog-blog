...
const NavBar = ()=>{
    ...
    return(
        <div className="flex sticky top-0 z-50 justify-between items-center border-b shadow-md bg-base-100 ">
            <div className="hidden lg:flex justify-around gap-x-5 lg:mx-32  xl:mx-44 w-full">
                ...
                <ul className="flex justify-center items-center gap-x-2 py-2 xl:text-xl font-semibold ">
                    {/* <li className=" border-r-2 pr-2">
                        <div className="relative ">
                            ...
                            <input type="search" placeholder="Search..." name="query" className="w-full pl-10 pr-2 py-2 rounded-full border bg-base-100 focus:outline-none focus:ring-1 focus:ring-[#FF2DAA] focus:border-[#FF2DAA] transition-all duration-200" />
                        </div>
                    </li> */}
